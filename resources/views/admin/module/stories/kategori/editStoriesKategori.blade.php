    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="">Edit Kategori Stories</a>
                </li>
            </ul>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row ">
                    <div class="col-sm-8">
                        <div class="card-title"> Edit Stories Kategori </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="/admin/edit/data/kategori-stories/store/{{ $editKategori->slug }}" method="post">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label>Nama Kategori</label>
                        <div class="input-group mb-3">
                            <input type="text" name="nama_kategori" value="{{ $editKategori->nama_kategori }}" class="form-control
